...
<img width="2172" height="724" alt="图片" src="https://github.com/user-attachments/assets/7306d8c7-a504-4c27-babc-b9238be7cb53" />
...
## Not another legal skill.

很多 Legal Skills 已经能很好地完成一个具体任务：检索法源、分析问题、审查合同、起草文书。

但真实的法律工作，很少在一次回答之后结束。

核对事实与法源、判断风险等级、把修改意见逐条写回合同、准备谈判回退方案、整理成 Word 或报告，再经过专业人员复核、流转与归档——这些步骤共同构成了一项法律工作的完整流程。

一段看起来不错的回答，距离一份可以提交、流转和真正使用的法律成果，中间往往还隔着多个连续的工作节点。

**LawBox 不是再增加一个 Legal Skill。**

它把检索、分析、审查、起草、修改、交付等能力组织在同一个工作框架里，让 Skill 不再只负责一个孤立步骤，而能够沿着真实法律工作流继续完成任务。

**Most legal skills solve a task. LawBox connects the work.**
