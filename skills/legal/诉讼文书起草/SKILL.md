...
本 Skill 负责“表达”，不重新成为决策引擎。法律关系判断、请求权选择、诉请与抗辩决策由 `初步法律分析` 与法律工作总控推理控制层（`reasoning-mode-protocol.md`、`matter-model-protocol.md`、`adversarial-review-protocol.md`、`judgment-protocol.md`）形成。
